  ...
  return (
    <>
      <main id='properties'>
            ...
            >
              <SwiperSlide>
                ...
                <div className="card-body">
                  ...
                  <p>Price : $1,250,000</p>
                  <a href="#" className="btn " id='view-btn'>View Property Details</a>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <img src="./assets/image1.png" className="card-img-top" alt="..." />
        ...
        <div className='col-12 d-flex flex-wrap' id='form'>
          ...
          <form className='d-flex flex-wrap col-12 p-5'>
            <div className="first-name col-3">
              <label htmlFor="text">
                <p>First Name</p>
                <input type="text" id="ftname" value={form.firstName} placeholder='Enter Fist Name' required />
              </label>
            </div>
